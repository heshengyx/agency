				...
				<ul class="nav ace-nav">
					...
					<li class="green"><a data-toggle="dropdown"
						...
						<ul
							...
							<li><a href="#"> <img src="${ctx}/avatars/avatar.png"
							...
							<li><a href="#"> <img src="${ctx}/avatars/avatar3.png"
							...
							<li><a href="#"> <img src="${ctx}/avatars/avatar4.png"
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="${ctx}/avatars/user.jpg" alt="Jason's Photo" /> <span
				...
				<ul class="nav nav-list">
					...
					<li class="active open"><a href="#" class="dropdown-toggle">
						...
						<ul class="submenu">
							...
							<li class="active"><a href="error-404.html"> <i
								...
								<div class="well">
									...
									<div>
										...
										<ul class="list-unstyled spaced inline bigger-110 margin-15">
											<li><i class="icon-hand-right blue"></i> Re-check the
												url for typos</li>

											<li><i class="icon-hand-right blue"></i> Read the faq</li>

											<li><i class="icon-hand-right blue"></i> Tell us about
												it</li>
										</ul>
									</div>
